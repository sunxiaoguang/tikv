...
use engine_traits::{CF_DEFAULT, CF_LOCK, CF_RAW_DEFAULT, CF_WRITE};
...
impl Statistics {
    pub fn details(&self) -> [(&'static str, [(&'static str, usize); 11]); 4] {
        [
    ...
    pub fn details_enum(&self) -> [(GcKeysCF, [(GcKeysDetail, usize); 11]); 4] {
        [
